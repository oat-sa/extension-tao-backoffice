...
use oat\tao\model\menu\Tree as TreeInterface;
use oat\tao\model\menu\Action as ActionInterface;

class Section extends MenuElement implements PhpSerializable, \oat\tao\model\menu\Section
{

...
class Action implements PhpSerializable, ServiceManagerAwareInterface, \oat\tao\model\menu\Action
{
    ...
    public static function fromSimpleXMLElement(\SimpleXMLElement $node, $structureExtensionId)
    {
        ...
        $data = [
            ...
            'multiple'   => isset($node['multiple']) ? (trim(strtolower((string) $node['multiple'])) == 'true')  : false,
